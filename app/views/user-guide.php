				...
				<div id="summary-content">
					<ul>
						...
						<ul>
							...
							<li><a href="#quotation-marks-rule">Quotation mark rule</a></li>
	...
	<h2>Rules editor (Adding a new rule)</h2>
		...
		<div id="plural-separator-rule">
			<h3>"Plural separator [...]" rule : </h3>
				<p class="user-guide-content">
					This rule type is dedicated to translators who use specific character to separate strings and plural strings in traduction files.<br/>
		...
		<h2>Special characters</h2>
			...
			<p class="user-guide-content">
				In order to add rules to a set of rules, Typolib' can use special characters : <br/><br/>
					...
					<br/>
					This is a non-breaking space but thiner. It is used in French for example (before " : ; ? ! » " and after " « ")
